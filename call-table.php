...
<head>
    ...
    <title>جدول التغذية الراجعة</title>
    ...
    <link rel="stylesheet" href="css/call-table.css">
...
<header class="header_area" style="direction: rtl;">
    ...
    <table class="table table-striped text-center">
        ...
        <?php
        $query="select * from callme";
        $result=mysqli_query($conn,$query); 
        while($row=mysqli_fetch_assoc($result)){
            echo"<tr><td>".$row['ID']."</td><td>".$row['Fullname']."</td><td>".$row['E-mail']."</td><td>".$row['Object']."</td><td>".$row['Message']."</td><td>"."&nbsp;<a class='btn btn-info' href='tel:{$row["E-mail"]}'>Email</a>"."</td></tr>";
        }
        ?>
        </table>
</body>
