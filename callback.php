...
if(isset($_POST["sub"])){
    if(empty($name)||empty($email)||empty($message)){
        ...
        if($check&&$Error_Flag_N==false&&$Error_Flag_P==false&&$Error_Flag_text==false&&$Error_Flag_object==false){
            if('$submit'){
            $query="INSERT INTO callme VALUES (default,'$name','$email','$object','$message')";
