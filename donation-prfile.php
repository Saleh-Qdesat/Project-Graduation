            ...
            <nav class="navbar  navbar-expand-lg navbar-light   " style="direction: rtl; ">
                <div class="container">
                   ...
                   <li class="nav-item"><a class="nav-link" href="visit.php">طلب زيارة للجمعية</a></li>
                         ...
                         <li class="nav-item active">  <a class="nav-link" href="donation-prfile.php">
                                        <span>
                                            تبرع الآن
                                        </span>
                                    </a></li> 
                ...
                <div class="info col-md col-xs-12">
                    <div class="information">
                        ...
                        <div class="information3">
                            <a href="call.php"> <button type="button" class="btn" style="background-color: orange; font-weight: bold; float: right;  ">إتصل  بنا</button></a>
                        </div>
...
<br>JIBAJOAMXXX</p>
        ...
        <div class=" mas col-12 col-md-3 mbr-fonts-style display-7 ">
            ...
            <p class="mbr-text"><br><em><a href="http://www.facebook.com">مشروع ايواء دار الاحسان
</a><br></em>
<br><a href="http://www.facebook.com">مشروع الكفالات الخارجية
</a><br>
<br><a href="http://www.facebook.com">مشروع قادة المستقبل
</a><br>
<br><a href="http://www.facebook.com">صندوق طالب العلم اليتيم
</a><br>
<br><a href="http://www.facebook.com">المشاريع الموسمية</a></p>
        </div>
    </div>
