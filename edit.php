            ...
            <div class="row">
                ...
                <div class="inputs  col-md-5 col-xs-12">
                    ...
                    <div class="input pb-3">
                        <input type="text" name="name" class="form-control" placeholder="الأسم الأول" size="50px">
                        <div class="Error" style=" margin-bottom:-7px; font-weight:bold; color:red"> <?php echo "<center>" . $Erorr_array['name'] . "</center>" ; ?></div>
                    </div>
                    <div class="input pb-3">
                        <input type="text" name="name1" class="form-control" placeholder="الأسم الأخير" size="50px">
