...
<link rel="icon" href="img/ihsan.png" type="image/png">
    ...
    <title>الهيئة الادارية/دار الاحسان</title>
...
<div class="header text-center">
    <h1>الهيئة الإدارية للجمعية</h1>
</div>
<div class="manage">
    <div class="container">
        <div class="row">
            <div class="col-md-4 col-xs-12 ">
                <img src="img/باهر-العدناني.jpg">
                <p class="lead1">المهندس باهر محمد خورشيد العدناني</p>
                <p class="lead text-center">رئيس الهيئة الإدارية</p>

            </div>
            <div class="col-md-4 col-xs-12 ">
                <img src="img/إبراهيم-الشامي.jpg">
                <p class="lead1">السيد ابراهيم شوكت ابراهيم الشامي</p>
                <p class="lead text-center">نائب رئيس الهيئة الإدارية</p>

            </div>
            <div class="col-md-4 col-xs-12 ">
                <img src="img/محمد-القريوتي.jpg">
                <p class="lead1">السيد محمد سليمان سليم القريوتي</p>
                <p class="lead text-center">أمين الصندوق</p>

            </div>
            <div class="col-md-4 col-xs-12 ">
                <img src="img/محمد-فرماوي.jpg">
                <p class="lead1">المهندس محمد عثمان محمد الفرماوي</p>
                <p class="lead text-center">أمين السر</p>

            </div>
            <div class="col-md-4 col-xs-12 ">
                <img src="img/محمدحسن-محمد-رسول-عبدالحليم-الكيلاني.jpg">
                <p class="lead1">السيد محمد حسن عبدالحليم الكيلاني</p>
                <p class="lead text-center">عضو</p>

            </div>
            <div class="col-md-4 col-xs-12 ">
                <img src="img/مازن-محمد-عبدالله-الحمود.jpg">
                <p class="lead1">السيد مازن محمد عبدالله الحمود</p>
                <p class="lead text-center">عضو</p>

            </div>
            <div class="bord col-md-4 col-xs-12 ">
                <img src="img/daralehsan-partial-logo-400x400.png">
                <p class="lead1">السيد مصطفى كامل مصطفى شويخ</p>
                <p class="lead text-center">عضو</p>
