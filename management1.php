...
<link rel="icon" href="img/ihsan.png" type="image/png">
    ...
    <title>الهيئة الإدارية/دار الإحسان</title>
    ...
    <link rel="stylesheet" href="css/management1.css">
...
<div class="header text-center">
    <h1>الهيئة التنفيذية للجمعية</h1>
</div>
<div class="manage">
    <div class="container">
        <div class="row">
            <div class="col-md-4 col-xs-12 ">
                <img src="img/مسعود-هندية.jpg">
                <p class="lead1">السيد مسعود هندية</p>
                <p class="lead text-center">المدير العام</p>

            </div>
            <div class="col-md-4 col-xs-12 ">
                <img src="img/منى-الدريدي.jpg">
                <p class="lead1">السيدة منى الدريدي</p>
                <p class="lead text-center">المديرة التنفيذية</p>

            </div>
            <div class="col-md-4 col-xs-12 ">
                <img src="img/عمار-ساغة.jpg">
                <p class="lead1">السيد عمار ساغة</p>
                <p class="lead text-center">المدير المالي</p>

            </div>
            <div class="col-md-4 col-xs-12 ">
                <img src="img/حسن-الشيخ-حسن.jpg">
                <p class="lead1">السيد حسن الشيخ حسن</p>
                <p class="lead text-center">رئيس قسم الكفالات</p>

            </div>
            <div class="col-md-4 col-xs-12 ">
                <img src="img/ثقيف-ابو-عاصي.jpg">
                <p class="lead1">السيد ثقيف ابو عاصي</p>
                <p class="lead text-center">المحصل المالي</p>

            </div>
            <div class="col-md-4 col-xs-12 ">
                <img src="img/معتصم-سمور.jpg">
                <p class="lead1">السيد معتصم السمور</p>
                <p class="lead text-center">موظف الدعم اللوجستي</p>

            </div>
            <div class="col-md-4 col-xs-12 ">
                <img src="img/خالد-داود-1.jpg">
                <p class="lead1">السيد خالد داود</p>
                <p class="lead text-center">مندوب علاقات محسنين </p>

            </div>
            <div class="col-md-4 col-xs-12 ">
                <img src="img/ساجدة-اللواحمة.jpg">
                <p class="lead1">السيدة ساجدة اللواحمة</p>
                <p class="lead text-center"> الباحثة الاجتماعية  </p>

            </div>
            <div class="col-md-4 col-xs-12 ">
                <img src="img/كنانة-العلي.jpg">
                <p class="lead1">السيدة كنانة العلي</p>
                <p class="lead text-center">   السكرتاريا</p>
