...
<link rel="icon" href="img/ihsan.png" type="image/png">
    ...
    <title>رسالتنا/دار الإحسان</title>
...
<div class="hea text-center">
    <h1>رسالتنا</h1>
</div>
<div class="messages text-center">
   <p class="lead">دعم اليتيم بكل ما نملك وتنمية مهاراته ، وتشجيعه على الإنتاج والإبداع في المجتمع <br> وتقديم خدمات التعليم، والصحة والدعم النفسي </p>
...
<div class="word">
    <h2>الإخلاص:</h2>
    <p class="lead">جهودنا نابعة من إخلاصنا لله وللمجتمع ولخدمة الإنسانية</p>
</div>
<div class="word">
    <h2>الشفافية:</h2>
    <p class="lead">نسعى إلى تعزيز مبادئ الشفافية، ونظم المسائلة والمحاسبة وقيم النزاهة في جميع أعمالنا</p>
</div>
<div class="word">
    <h2>التميز:</h2>
    <p class="lead">جميع برامجنا تتميز بالجودة العالية والسلوك الإنساني الرفيع، لنستطيع مساعدة أكبر عددٍ ممكن من الأيتام</p>
</div>
<div class="word">
    <h2>الحيادية:</h2>
    <p class="lead">الحرص على تقديم المساعدات الإنسانية لكل ذي حاجة والأولوية للأكثر إحتياجاً، بغض النظر عن والعرق والإعتقاد والطبقة.</p>
</div>
